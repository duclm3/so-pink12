 ...
 * <code>book.service.impl.BookLocalServiceImpl</code> and
...
public class BookLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>book.service.impl.BookLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static book.model.Book addBook(book.model.Book book) {
	 ...
	 * @return the new book
	 */
	public static book.model.Book createBook(String isbn) {
		return getService().createBook(isbn);
	}
	 ...
	 */
	public static book.model.Book deleteBook(book.model.Book book) {
	 ...
	 */
	public static book.model.Book deleteBook(String isbn)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteBook(isbn);
	}
	...
	public static book.model.Book fetchBook(String isbn) {
		return getService().fetchBook(isbn);
	}
	 ...
	 * @throws PortalException if a book with the primary key could not be found
	 */
	public static book.model.Book getBook(String isbn)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getBook(isbn);
	}
	 ...
	 */
	public static java.util.List<book.model.Book> getBooks(int start, int end) {
	 ...
	 */
	public static book.model.Book updateBook(book.model.Book book) {
